...
export default function ComponentsPage() {
  ...
  const getProductImageSrc = (product: Product) => {
    const productIdMap: { [key: string]: string } = {
      ...
      'Corsair Vengeance LPX 32GB': 'corsair-vengeance-lpx-32gb',
      'Samsung 980 PRO 2TB': 'samsung-980-pro-2tb',
      'ASUS ROG Strix X670E-E': 'asus-rog-strix-x670e-e',
      'Corsair RM850x PSU': 'corsair-rm850x-psu'
    };
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
              Build your dream PC with our premium selection of processors, 
              graphics cards, memory, storage, and other essential components.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {isLoading ? (
          <div className="text-center py-20">
            ...
            <p className="text-text-secondary">Loading components...</p>
          </div>
        ) : error ? (
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-semibold text-white mb-4">Error loading components</h3>
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-semibold text-white mb-4">No components found</h3>
            <p className="text-text-secondary mb-8">
              {searchQuery 
                ? "Try adjusting your search terms to find what you're looking for."
                : "No components are available at the moment. Please check back later."
              }
            </p>
            {searchQuery && (
              <button
