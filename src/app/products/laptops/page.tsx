...
export default function LaptopsPage() {
  ...
  const getProductImageSrc = (product: Product) => {
    const productIdMap: { [key: string]: string } = {
      ...
      'Dell XPS 15 9520': 'dell-xps-15',
      'Razer Blade 15 Advanced': 'razer-blade-15',
      'MSI GE76 Raider': 'msi-ge76-raider'
    };
  ...
  useEffect(() => {
    const fetchLaptops = async () => {
      try {
        ...
        setError(err instanceof Error ? err.message : 'Failed to fetch laptops');
      } finally {
        setIsLoading(false);
      }
    };
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
              Discover our premium collection of gaming and professional laptops, 
              designed to deliver exceptional performance for work and play.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {isLoading ? (
          <div className="text-center py-20">
            ...
            <p className="text-text-secondary">Loading laptops...</p>
          </div>
        ) : error ? (
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-semibold text-white mb-4">Error loading laptops</h3>
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-semibold text-white mb-4">No laptops found</h3>
