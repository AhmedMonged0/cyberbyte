...
export default function PeripheralsPage() {
  ...
  const getProductImageSrc = (product: Product) => {
    const productIdMap: { [key: string]: string } = {
      'Corsair K95 RGB Platinum XT': 'corsair-k95-rgb-platinum-xt',
      ...
      'SteelSeries Rival 650 Wireless': 'steelseries-rival-650-wireless',
      'HyperX Cloud Alpha S Gaming Headset': 'hyperx-cloud-alpha-s'
    };
  ...
  const brands = ['all', 'Corsair', 'Logitech', 'SteelSeries', 'Razer', 'HyperX'];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
              Enhance your gaming experience with our premium collection of keyboards, 
              mice, headsets, and other gaming peripherals from top brands.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              <h2 className="text-3xl font-bold text-white mb-2">Gaming Peripherals</h2>
              <p className="text-text-secondary text-lg">
                Showing {filteredProducts.length} peripherals
              </p>
            </div>
              ...
              {isLoading ? (
                <div className="col-span-full flex justify-center items-center py-20">
                  <div className="text-center">
                    ...
                    <p className="text-text-secondary">Loading peripherals...</p>
                  </div>
                </div>
              ) : error ? (
                <div className="col-span-full text-center py-20">
                  ...
                  <h3 className="text-2xl font-semibold text-white mb-4">Error loading peripherals</h3>
                ...
                <div className="col-span-full text-center py-20">
                  ...
                  <h3 className="text-2xl font-semibold text-white mb-4">No peripherals found</h3>
