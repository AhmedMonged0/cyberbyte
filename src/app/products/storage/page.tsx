...
export default function StoragePage() {
  ...
  const getProductImageSrc = (product: Product) => {
    const productIdMap: { [key: string]: string } = {
      'Samsung 980 PRO 2TB NVMe SSD': 'samsung-980-pro-2tb',
      'WD Black SN850X 1TB NVMe SSD': 'wd-black-sn850x-1tb',
      'Seagate BarraCuda 4TB HDD': 'seagate-barracuda-4tb',
      'Crucial MX4 2TB SATA SSD': 'crucial-mx4-2tb',
      'Samsung 970 EVO Plus 1TB NVMe SSD': 'samsung-970-evo-plus-1tb',
      'Crucial P5 Plus 2TB NVMe SSD': 'crucial-p5-plus-2tb',
      'WD Blue 4TB SATA HDD': 'wd-blue-4tb',
      'SanDisk Extreme Pro 1TB Portable SSD': 'sandisk-extreme-pro-1tb'
    };
  ...
  const brands = ['all', 'Samsung', 'WD', 'Seagate', 'Crucial', 'SanDisk'];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
              Upgrade your storage with our collection of high-performance SSDs, HDDs, 
              and portable storage solutions for all your data needs.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              <h2 className="text-3xl font-bold text-white mb-2">Storage Solutions</h2>
              <p className="text-text-secondary text-lg">
                Showing {filteredProducts.length} storage devices
              </p>
            </div>
              ...
              {isLoading ? (
                <div className="col-span-full flex justify-center items-center py-20">
                  <div className="text-center">
                    ...
                    <p className="text-text-secondary">Loading storage devices...</p>
                  </div>
                </div>
              ) : error ? (
                <div className="col-span-full text-center py-20">
                  ...
                  <h3 className="text-2xl font-semibold text-white mb-4">Error loading storage devices</h3>
                ...
                <div className="col-span-full text-center py-20">
                  ...
                  <h3 className="text-2xl font-semibold text-white mb-4">No storage devices found</h3>
                    ...
                    {viewMode === 'grid' ? (
                      ...
                      <div className="relative bg-gradient-to-br from-accent-gray to-primary-black-secondary rounded-2xl overflow-hidden border border-accent-blue/30 hover-lift">
                        ...
                        <div className="absolute top-4 left-4 z-10">
                          <div className={`px-3 py-1 bg-gradient-to-r ${getBadgeColor(product.isFeatured ? 'Featured' : 'High Performance')} text-white text-xs font-semibold rounded-full`}>
                            {product.isFeatured ? 'Featured' : 'High Performance'}
                          </div>
                        </div>
